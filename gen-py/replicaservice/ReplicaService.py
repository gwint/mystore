...
class Iface(object):
    ...
    def get(self, key, clientIdentifier, requestIdentifier):
        """
        Parameters:
         - key
         - clientIdentifier
...
class Client(Iface):
    ...
    def get(self, key, clientIdentifier, requestIdentifier):
        ...
        """
        self.send_get(key, clientIdentifier, requestIdentifier)
        return self.recv_get()

    def send_get(self, key, clientIdentifier, requestIdentifier):
    ...
    def getInformation(self):
        self.send_getInformation()
        return self.recv_getInformation()

    def send_getInformation(self):
        self._oprot.writeMessageBegin('getInformation', TMessageType.CALL, self._seqid)
        args = getInformation_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getInformation(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
...
class Processor(Iface, TProcessor):
    ...
    def process_get(self, seqid, iprot, oprot):
        ...
        result = get_result()
        try:
            result.success = self._handler.get(args.key, args.clientIdentifier, args.requestIdentifier)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_getInformation(self, seqid, iprot, oprot):
        args = getInformation_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getInformation_result()
        try:
            result.success = self._handler.getInformation()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getInformation", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class get_args(object):
    ...
    def __init__(self, key=None, clientIdentifier=None, requestIdentifier=None,):
        self.key = key
    ...
    def write(self, oprot):
        ...
        if self.clientIdentifier is not None:
            oprot.writeFieldBegin('clientIdentifier', TType.STRING, 2)
        ...
        if self.requestIdentifier is not None:
            oprot.writeFieldBegin('requestIdentifier', TType.I32, 3)
...
get_args.thrift_spec = (
    ...
    (2, TType.STRING, 'clientIdentifier', 'UTF8', None, ),  # 2
    (3, TType.I32, 'requestIdentifier', None, None, ),  # 3
)
...
class getInformation_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getInformation_args')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getInformation_args)
getInformation_args.thrift_spec = (
)


class getInformation_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getInformation_result')
        if self.success is not None:
